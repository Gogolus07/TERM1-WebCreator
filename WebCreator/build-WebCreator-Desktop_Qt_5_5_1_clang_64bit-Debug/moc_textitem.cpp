...
QT_MOC_LITERAL(5, 35, 14), // "selectedChange"
QT_MOC_LITERAL(6, 50, 14) // "QGraphicsItem*"

    },
    "TextItem\0lostFocus\0\0TextItem*\0item\0"
...
void TextItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TextItem::*_t)(TextItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextItem::lostFocus)) {
                *result = 0;
            }
        }
        {
            typedef void (TextItem::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextItem::selectedChange)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void TextItem::selectedChange(QGraphicsItem * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

...
map<string, string> Element::getAllAttribute()
{
    return m_attributes;
}
...
map<string, string> Element::getAllStyle()
{
    return m_styles;
}
...
std::string Element::getStyleGenerate() const{
    std::string style_str="";
    /*ICI la partie du style a parcourir*/
...
string Element::toString() const
{
    ...
    if(m_elementName=="textException")
    {
        ...
        res+="<"+m_elementName+" "+getStyleGenerate()+" id = \""+m_id+"\">";
        res+=m_content;
